...
and an effective temperature of Teff=1250$\pm$200 K.
}
...
(Contamination by a foreground or background field L dwarf is still possible).
...
integration time and to obtain  spectroscopic results. 
If we can confirm the belief that the companion is a planet these would be the first images of an exoplanet.}
...
CONICA) for J, H and Ks band. This mode is dedicated to the sharp imaging of red sources V − K $\ge$ 6 (M5 or later spectral type), but this cannot 
be used for  L' filter and specter and we use VIS dichroic (90\% flux to the wavefront sensor and 90\% to the camera) for these. 
...
We use as reference star for adaptive optics the same target star -  
